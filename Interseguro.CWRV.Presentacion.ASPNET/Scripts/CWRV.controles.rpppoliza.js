...
$(document).ready(function () {
    ...
    $('#TablaAfiliadosReintentar_RP').live('click', function () {
...
function CargarTablaSolicitudes_RP() {
    ...
    $.ajax({
        type: 'POST',
        url: '../RentaPrivadaPlus/ListadoCierrePlus.aspx/CargarTablaSolicitudes',
        contentType: "application/json; charset=iso-8859-1",
        dataType: 'json',
        data: $.toJSON(params),
        success: function (data) {
...
function CargarTablaCotizacionesCierre_RP(cot, temporalidad, moneda, conyuge) {
    ...
    $.ajax({
        type: "POST",
        url: "CerrarSolicitud.aspx/CargarTablaCotizaciones",//<INIGTI_753>
        contentType: "application/json; charset=iso-8859-1",
        dataType: "json",
        data: $.toJSON(params),
        success: function (data) {
            ...
            if ($('#HEstado').val() == "1") {//Seleccionada
                ...
                botonModSolAnularBloqueado = false;
                $('#ModSolAnularCierre_RP').attr('class', 'boton darkblue sharp');
