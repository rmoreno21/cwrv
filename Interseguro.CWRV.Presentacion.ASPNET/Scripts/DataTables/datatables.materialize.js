var es_PE = {
    ...
    "processing": "",
    "search": "Buscar:",
    "zeroRecords": "No se encontraron ocurrencias",
    "paginate": {
        "first": "«",
        "last": "»",
        "next": ">",
    ...
    "aria": {
        "sortAscending": ": activar ordenar columna ascendentemente",
        "sortDescending": ": activar ordenar columna descendentemente"
    }
}
var $jscomp = $jscomp || {};
$jscomp.scope = {};
...
(function (a) {
    ...
    a.extend(!0, d.defaults, {
        dom: "<'row'<'col s12 m6'l><'col s12 m6'f>><'row'<'col s12'tr>><'row'<'col s12 m6'i><'col s12 m6 center'p>>",
