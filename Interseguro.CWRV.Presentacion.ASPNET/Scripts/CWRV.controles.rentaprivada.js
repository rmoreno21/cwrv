...
function CargarTablaCotizaciones_RP(cot, temporalidad, moneda) {
...
/* Se comenta, función obsoleta */
//function CargarTablaActividades()
//{
//    if ($.trim($('#CUSPP').val()).length > 0) {
//        $('#TablaActividadesContenedor').hide();
//        $('#TablaActividadesCargando').show();
//        var params = {
//            tokenUsuario: $('#TokenUsuario').val(),
//            cuspp: $('#CUSPP').val()
//        }
//        $.ajax({
//            type: 'POST',
//            url: 'Cotizador.aspx/CargarTablaActividades',
//            contentType: "application/json; charset=iso-8859-1",
//            dataType: 'json',
//            data: $.toJSON(params),
//            success: function (data) {
//                if (data.d != 'TOKEN') {
//                    $('#TablaActividadesCargando').hide();
//                    $('#TablaActividadesContenedor').show();
//                    $('#TablaActividadesContenedor').html($(data.d).find('#ContenidoDinamico').html());
...
//                    }
//                    else {
//                        $('#TabTelefonosVerMas').html('Ver más recientes');
//                    }
//                }
//                else {
//                    CerrarSesionExpirada();
