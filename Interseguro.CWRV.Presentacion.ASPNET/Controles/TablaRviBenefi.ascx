<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="TablaRviBenefi.ascx.cs" Inherits="Interseguro.CWRV.Presentacion.ASPNET.Controles.TablaRviBenefi" %>
<form id="form1" runat="server" enableviewstate="False">
<div id="ContenidoDinamico">
    <asp:GridView ID="TabRviBenefi" runat="server" Width="100%" CellPadding="3" 
        ...
        onrowdatabound="TabRviBenefi_RowDataBound" >
