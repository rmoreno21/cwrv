...
namespace Interseguro.CWRV.Presentacion.ASPNET.Controles
{
    ...
    public partial class TablaCotizacionesPlan1IFPCierre : System.Web.UI.UserControl
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            TabCotizaciones_IFP_P1.Columns[9].Visible = Utilitarios.ValidarRedLocal(Request.UserHostAddress);
            ...
            TabCotizaciones_IFP_P1.Columns[15].Visible = PermisoEspeciales;
            TabCotizaciones_IFP_P1.Columns[16].Visible = PermisoTRA;
