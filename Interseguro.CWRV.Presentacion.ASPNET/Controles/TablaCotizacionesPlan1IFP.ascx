<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="TablaCotizacionesPlan1IFP.ascx.cs" Inherits="Interseguro.CWRV.Presentacion.ASPNET.Controles.TablaCotizacionesPlan1IFP" %>
...
<form id="form1" runat="server" enableviewstate="False">
    ...
    <div id="ContenidoDinamico">
        ...
        <asp:GridView ID="TabCotizaciones_IFP_P1" runat="server" Width="100%" CellPadding="0"
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="Plazo de póliza">
                    <ItemTemplate>
                        <asp:DropDownList ID="TabCotTemporalidad" runat="server" ClientIDMode="Static" CssClass="formTextboxGrid ModSolTemporalidad" Width="45">
                        </asp:DropDownList>
                    </ItemTemplate>
                ...
                <asp:TemplateField HeaderText="Años ingreso esc.">
                    <ItemTemplate>
                        <asp:DropDownList ID="TabCotPagoEscalonada" runat="server" ClientIDMode="Static" CssClass="formTextboxGrid ModSolPagoEscalonada" Width="60">
                        </asp:DropDownList>
                    </ItemTemplate>
                    <ItemStyle HorizontalAlign="Center" Width="45px" />
                </asp:TemplateField>
                ...
                <asp:TemplateField HeaderText="% Dev. Sobrev.">
                    <ItemTemplate>
                        <asp:DropDownList ID="TabCotDevolucion" runat="server" ClientIDMode="Static" CssClass="formTextboxGrid ModSolSobrevivencia" Width="60">
                        </asp:DropDownList>
                    </ItemTemplate>
                ...
                <asp:TemplateField HeaderText="% Dev. Fallec.">
                    <ItemTemplate>
                        <asp:DropDownList ID="TabCotDevolucionFallecimiento" runat="server" ClientIDMode="Static" CssClass="formTextboxGrid ModSolFallecimiento" Width="60">
                        </asp:DropDownList>
                    </ItemTemplate>
                    <ItemStyle HorizontalAlign="Center" Width="60px" />
                </asp:TemplateField>
                ...
                <asp:TemplateField HeaderText="Renta tramo 1">
                    <ItemTemplate>
                        <asp:Label ID="ItemRentaDoble" runat="server" Text='<%# string.Format("{0:#,##0.00}", (Convert.ToInt32(Eval("PjePagoDoble")) > 0) ? Eval("PensionCiaMO") + " <br> (" + string.Format("{0:#,##0.00}",Eval("ValPrimeraRentaIS")) + ")"  : "0.00"  ) %>'></asp:Label>
                    </ItemTemplate>
                ...
                <asp:TemplateField HeaderText="Renta mensual">
                    <ItemTemplate>
                        <asp:Label ID="ItemRenta" runat="server" Text='<%# string.Format("{0:#,##0.00}", (Convert.ToInt32(Eval("PjePagoDoble")) > 0) ? Eval("Pension2doTramo") : Eval("PensionCiaMO") + " <br> (" + string.Format("{0:#,##0.00}",Eval("ValPrimeraRentaIS")) + ")") %>'></asp:Label>
                    </ItemTemplate>
        ...
        <asp:Panel ID="TabCotizacionesBotonera_IFP" CssClass="formLinea" align="right" runat="server">
            <asp:HyperLink ID="TabCotizacionesAgregarPlan1_IFP" CssClass="boton darkblue sharp" Style="width: 80px; height: 22px" runat="server" ClientIDMode="Static">Agregar</asp:HyperLink>
        </asp:Panel>

        <%--<asp:Panel ID="TabCotizacionesLeyenda_IFP" runat="server" Visible="true">
        <fieldset>
