<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="TablaGrupoFamiliarCapitalRequerido.ascx.cs" Inherits="Interseguro.CWRV.Presentacion.ASPNET.Controles.TablaGrupoFamiliarCapitalRequerido" %>

<asp:GridView ID="TabrupoFamiliarCapitalRequerido" runat="server" Width="100%" CellPadding="3" 
    CellSpacing="1" GridLines="None" UseAccessibleHeader="True"
    ViewStateMode="Disabled" ClientIDMode="Static" AutoGenerateColumns="False" OnRowDataBound="TablaGrupoFamiliarCapitalRequerido_RowDataBound">
