<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="TablaCotizacionesPlan2IFP.ascx.cs" Inherits="Interseguro.CWRV.Presentacion.ASPNET.Controles.TablaCotizacionesPlan2IFP" %>
...
<form id="form1" runat="server" enableviewstate="False">
    ...
    <div id="ContenidoDinamico">
        ...
        <asp:GridView ID="TabCotizaciones_IFP_P2" runat="server" Width="100%" CellPadding="0"
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="Plazo y PG">
                    <ItemTemplate>
                        <asp:DropDownList ID="TabCotTemporalidad" runat="server" ClientIDMode="Static" CssClass="formTextboxGrid ModSolTemporalidad" Width="60">
                        </asp:DropDownList>
                    </ItemTemplate>
                ...
                <asp:TemplateField HeaderText="% Devol.">
                    <ItemTemplate>
                        <asp:DropDownList ID="TabCotDevolucion" runat="server" ClientIDMode="Static" CssClass="formTextboxGrid ModSolDevolucion" Width="60">
                        </asp:DropDownList>
                    </ItemTemplate>
        ...
        <asp:Panel ID="TabCotizacionesBotonera_IFP" CssClass="formLinea" align="right" runat="server">
            <asp:HyperLink ID="TabCotizacionesAgregarPlan2_IFP" CssClass="boton darkblue sharp" Style="width: 80px; height: 22px" runat="server" ClientIDMode="Static">Agregar</asp:HyperLink>
        </asp:Panel>
