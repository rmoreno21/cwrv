...
{
    public partial class TablaSeguimiento : System.Web.UI.UserControl
    {
        public List<Seguimiento> DatosReporte { get; set; }
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (PermisoConsultar)
            {
                ...
                if (TotalRegistros > 0)
                {
                    TabSeguimiento.HeaderRow.TableSection = TableRowSection.TableHeader;
                    TabSegContenedorPaginador.Visible = true;
                }
                ...
                {
                    string paginador;
                    paginador = "<ul id=\"TabSeguimientoPaginador\" class=\"tsc_pagination tsc_paginationB tsc_paginationB02\">";
                    if (IndicePagina > 1)
                    {
                    ...
                    TabSeguimientoPaginador.Text = paginador;

                    TabSeguimientoPaginadorIndice.Text = "Página " + IndicePagina + "/" + totalPaginas;
                }
            }
            else
            {
        ...
        protected void TabSeguimiento_RowDataBound(object sender, GridViewRowEventArgs e)
        {
