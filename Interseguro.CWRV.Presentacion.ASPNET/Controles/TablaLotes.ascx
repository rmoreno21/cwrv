<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="TablaLotes.ascx.cs" Inherits="Interseguro.CWRV.Presentacion.ASPNET.Controles.TablaLotes" %>
<form id="form1" runat="server" enableviewstate="False">
<div id="ContenidoDinamico">
    <asp:GridView ID="TabLotes" runat="server" Width="100%" CellPadding="3" 
        ...
        <Columns>
            ...
            <asp:BoundField DataField="FechaCierre" HeaderText="Fecha de Plazo AFP" DataFormatString="{0:dd/MM/yyyy}">
                <ItemStyle HorizontalAlign="Center" />
            </asp:BoundField>
            <asp:BoundField DataField="FechaEnvio" HeaderText="Fecha de Ingreso" DataFormatString="{0:dd/MM/yyyy}">
                <ItemStyle HorizontalAlign="Center" />
            </asp:BoundField>
