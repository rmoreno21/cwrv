<%@ Page Title="" Language="C#" MasterPageFile="~/CotWebRVI.Master" AutoEventWireup="true" CodeBehind="DescargaResultados.aspx.cs" Inherits="Interseguro.CWRV.Presentacion.ASPNET.Meler.DescargaResultados" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Contenido" runat="server">
    <div id="Principal" align="left" style="width:860px;padding:20px;background:#FFF; border:1px solid #00466e">
        <h1 class="simple" style="width:195px">Descarga de Resultados</h1>

        <div class="formLinea">
            <label id="LabArchivo" for="Archivo" class="formLabel">Archivo de Carga*:</label>
    ...
    <div id="Principal2" align="left" style="width:860px;margin-top:15px;padding:20px;background:#FFF; border:1px solid #00466e">
        ...
        <div class="formLinea">
            <label id="LabFechaDesde" for="FechaDesde" class="formLabel formLabel2Izq">Fec. cierre com. desde:</label>
            ...
            <label id="LabFechaHasta" for="FechaHasta" class="formLabel formLabel2Der">Fec. cierre com. hasta:</label>
        ...
        <div class="formLinea" align="center">
            <asp:HyperLink ID="BuscarLoteResultados" style="width:80px;height:22px" CssClass="boton darkblue sharp" runat="server" ClientIDMode="Static">Buscar</asp:HyperLink>
        </div>
