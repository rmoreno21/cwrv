<%@ Page Title="" Language="C#" MasterPageFile="~/CotWebRVI.Master" AutoEventWireup="true" CodeBehind="DireccionAfiliado.aspx.cs" Inherits="Interseguro.CWRV.Presentacion.ASPNET.RentaPrivada.DireccionAfiliado" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Contenido" runat="server">
    ...
    <asp:Panel ID="Direccion_Afiliado" runat="server" ClientIDMode="Static" align="left" Style="width: 860px; padding: 20px; background: #FFF; border: 1px solid #00466e">
        ...
        <div id="ModDirControlCiudad" class="formLinea">
            <label id="LabModDirCiudad" for="ModDirCiudad" class="formLabel formLabel2Izq">Ciudad*:</label>
        ...
        <div id="ModDirControlComuna" class="formLinea">
            <label id="LabModDirComuna" for="ModDirComuna" class="formLabel formLabel2Izq">Comuna*:</label>
