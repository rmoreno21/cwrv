<%@ Page Title="" Language="C#" MasterPageFile="~/CotWebRVI.Master" AutoEventWireup="true" CodeBehind="TipoMoneda.aspx.cs" Inherits="Interseguro.CWRV.Presentacion.ASPNET.Simuladores.TipoMoneda" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Contenido" runat="server">
    ...
    <div align="left" style="width:860px;padding:20px;background:#FFF; border:1px solid #00466e;">
        <h1 id="tituloSimulador" class="simple" style="width:130px">Tipo de Moneda</h1>
        ...
        <div class="formLinea">
         ...
         <%--SRI.INI-20322--%>
        <div id="Recalcular" class="formLineaBotonSimulacion" align="left" style="margin:0">
            <asp:HyperLink ID="btnRecalcularTipoMoneda" NavigateUrl="#" style="width:150px;height:22px;display:none" CssClass="boton darkblue sharp" runat="server" ClientIDMode="Static">Recalcular Gráfico</asp:HyperLink>
        </div>
        <%--SRI.INI-20322--%>
        ...
        <div id="CotizacionesSimulador">
            <table id="GrupoCotizaciones" width="860" border="0" cellspacing="0" cellpadding="0" style="display:none">
                <tr class="grilla_cabecera">
                    <th align="center" style="width:286px;border-left:1px solid #FFF;border-right:1px solid #FFF">S/. INDEXADOS</th>
                    <th align="center" style="width:287px;border-left:1px solid #FFF;border-right:1px solid #FFF">S/. AJUSTADOS</th>
                    <th align="center" style="width:287px;border-left:1px solid #FFF;border-right:1px solid #FFF">$ AJUSTADOS</th>
                </tr>
                <tr>
                    <td valign="top">
        ...
        <div id="Simulaciones" style="display:none;height:603px">
            ...
            <div id="Simulacion" style="margin:10px 2px;width:850px;height:600px;" class="areaSimulacion">
            <%--SRI.FIN-20322--%>
            </div>
        </div>
        ...
        <div class="formLineaBotonSimulacion" align="center">
            <asp:HyperLink ID="btnNuevoCorreoTipoMoneda" style="width:150px;height:22px;display:none" CssClass="boton darkblue sharp" runat="server" ClientIDMode="Static">Enviar Correo</asp:HyperLink>
            <asp:HyperLink ID="btnPensionProyectadaTipoMoneda" style="width:150px;height:22px;display:none" CssClass="boton darkblue sharp" runat="server" ClientIDMode="Static">Pensión Proyectada</asp:HyperLink>
        </div>
    ...
    <div style="display:none">
        ...
        <div  id="ModalEnvioCorreoSimulador" title="Enviar Correo Electrónico">
            ...
            <div id="ModEnvCorContenidoSimulador" class="modalContenido">
                ...
                <div class="formLinea" align="center">
                    <a id="ModEnvCorEnviarSimuladorTipoMoneda" style="width:80px;height:22px" class="boton darkblue sharp">Enviar</a>
