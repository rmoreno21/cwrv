<%@ Page Title="" Language="C#" MasterPageFile="~/CotWebRVI.Master" AutoEventWireup="true" CodeBehind="JubilarseHoyFuturo.aspx.cs" Inherits="Interseguro.CWRV.Presentacion.ASPNET.Simuladores.JubilarseHoyFuturo" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Contenido" runat="server">
    ...
    <div align="left" style="width:860px;padding:20px;background:#FFF; border:1px solid #00466e;">
        <h1 id="tituloSimulador" class="simple" style="width:205px">¿Jubilarse hoy o a futuro?</h1>

        <table width="100%" cellspacing="0" cellpadding="0" border="0">
            <tr>
                <td valign="top">
                    <div class="formLinea">
                        <label id="LabAnhosJubilarse" class="formLabel formLabel2Izq">Años estimados a jubilarse*:</label>
                        <asp:DropDownList ID="AnhosJubilarse" runat="server" CssClass="formCombobox formComboboxReadOnly" Width="68" style="margin-left:-40px" ClientIDMode="Static" Enabled="False">
                        </asp:DropDownList>
                    </div>

                    <div class="formLinea">
                        <label id="LabTipoCambio" class="formLabel formLabel2Izq">Tipo de cambio*:</label>
                        <asp:TextBox ID="TipoCambio" runat="server" CssClass="formTextbox formTextboxReadOnly numerico" Width="60" data-v-max="100.000" data-v-min="0.000" style="margin-left:-40px" ClientIDMode="Static" Enabled="False"></asp:TextBox>
                    ...
                    <div class="formLinea">
                        ...
                        <asp:TextBox ID="PromedioRentabilitad" runat="server" CssClass="formTextbox formTextboxReadOnly numerico" data-v-max="100.000" data-v-min="-100.000" Width="60" style="margin-left:-40px" ClientIDMode="Static" Enabled="False"></asp:TextBox>
                        <span style="display:block;height:17px;padding-top:3px"><a target="_blank" href="http://www.sbs.gob.pe" class="formLink">www.sbs.gob.pe</a></span>
                    </div>
                    ...
                    <div class="formLineaBotonSimulacion" align="left" style="margin:0">
                        <asp:HyperLink ID="btnRecalcularJubiliarseHoyFuturo" NavigateUrl="#" style="width:150px;height:22px;" CssClass="boton darkblue sharp" runat="server" ClientIDMode="Static">Recalcular Gráfico</asp:HyperLink>
                    </div>
                    <%--SRI.INI-20322--%>
                ...
                <td valign="bottom" style="width:430px">
                    
                    <div id="Simulaciones" align="center" style="display:none;height:551px">
                        <%--SRI.INI-20322--%>
                        <%--<div id="Simulacion1" style="margin-left:10px;width:418px;height:543px;" class="areaSimulacion">--%>
                        <div id="Simulacion1" style="margin-left:10px;width:418px;height:560px;" class="areaSimulacion">
                        <%--SRI.FIN-20322--%>
                        </div>
                        <%--<div id="Simulacion1" style="margin:10px 2px;width:418px;height:535px;" class="areaSimulacion">
                        </div>--%>
                        <%--<div id="Simulacion1" style="float:left;margin:5px 5px 0 1px;width:418px;height:535px;" class="areaSimulacion">
                        </div>--%>

                        <%--<div id="Simulacion2" style="float:left;margin:5px 1px 0 5px;width:418px;height:535px;" class="areaSimulacion">
                        </div>--%>
                    </div>
                </td>
            </tr>
        ...
        <div class="formLineaBotonSimulacion" align="center">
            <asp:HyperLink ID="btnNuevoCorreoJubiliarseHoyFuturo" style="width:150px;height:22px;" CssClass="boton darkblue sharp" runat="server" ClientIDMode="Static">Enviar Correo</asp:HyperLink>
            <asp:HyperLink ID="btnPensionProyectadaJubiliarseHoyFuturo" style="width:150px;height:22px;" CssClass="boton darkblue sharp" runat="server" ClientIDMode="Static">Pensión Proyectada</asp:HyperLink>
        </div>
