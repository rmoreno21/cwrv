<%@ Page Title="" Language="C#" MasterPageFile="~/CotWebRVI.Master" AutoEventWireup="true" CodeBehind="CompararPlazoFijo.aspx.cs" Inherits="Interseguro.CWRV.Presentacion.ASPNET.Simuladores.CompararPlazoFijo" %>
<asp:Content ID="Content1" ContentPlaceHolderID="Cabecera" runat="server">
    ...
    <script type="text/javascript">
        ...
        function drawVisualization(dataValues) {
            ...
            data.addColumn('string', 'Edad del pensionario');
            data.addColumn('number', 'Pensión total');
...
<asp:Content ID="Content2" ContentPlaceHolderID="Contenido" runat="server">
    ...
    <div align="left" style="width:860px;padding:20px;background:#FFF; border:1px solid #00466e;">
        ...
        <h1 id="tituloSimulador" class="simple" style="width:260px">Rentas Vitalicias vs Plazo Fijo</h1>

       <div > <%--class="formLineaFieldSet"--%>
            <fieldset class="formFieldSet formFieldSet2Izq"> <%--<fieldset class="formFieldSet formFieldSet2Izq">--%>
               <legend>Plazo Fijo Soles</legend>
                
               <div class="formLinea">
                    <label id="LabDepositoPlazo" for="DepositoPlazo" class="formLabel formLabel2Izq">Depósito Plazo:</label>
                    <asp:TextBox ID="DepositoPlazo" runat="server" CssClass="formTextbox numerico" style="margin-left:-40px; text-align:right" ClientIDMode="Static" data-v-min="0.00" data-v-max="0.00" ></asp:TextBox>
               </div>

               <%--<div class="formLinea">
                   <label id="Label2" class="formLabel formLabel2Izq">Temporalidad:</label>
                   <asp:DropDownList ID="DropDownList1" runat="server" CssClass="formCombobox" Width="142" style="margin-left:-40px" ClientIDMode="Static" >
                   </asp:DropDownList>
               </div>--%>

               <div class="formLinea">
                   <label id="LabTEA" for="TEA" class="formLabel formLabel2Izq">TEA(%):</label>
                   <%--<asp:TextBox ID="TEA" runat="server" CssClass="formTextbox numerico" Width="50" style="margin-left:-40px; text-align:right" ClientIDMode="Static"></asp:TextBox>--%>
                   <asp:TextBox ID="TEA" runat="server" CssClass="formTextbox numerico" style="margin-left:-40px; text-align:right" ClientIDMode="Static"></asp:TextBox>
                   
                   <%--<asp:TextBox ID="TEMA" runat="server" CssClass="formTextbox formTextboxReadOnly numerico" Width="50" style="margin-left:10px; text-align:right" ClientIDMode="Static" readonly="true"></asp:TextBox>--%>
                   
                   <asp:HiddenField ID="TEM" runat="server" ClientIDMode="Static"/>

                   <%--<span style="display:block;height:17px;padding-top:5px; margin-left:50px;">&nbsp; %</span>--%>
               </div>

               <div class="formLinea">
                    <label id="LabAnhos" for="Anhos" class="formLabel formLabel2Izq">Años:</label>
                    <%--<asp:TextBox ID="Anhos2" runat="server" CssClass="formTextbox numerico" style="margin-left:-40px; text-align:right" ClientIDMode="Static"></asp:TextBox>--%>
                   
                   <asp:DropDownList ID="Anhos" runat="server" CssClass="formCombobox" style="margin-left:-40px; text-align:right" Width="142" ClientIDMode="Static" Enabled="True">
                   </asp:DropDownList>
                   
               </div>

               <div class="formLinea">
                    <label id="LabInteresDeposito" for="InteresDeposito" class="formLabel formLabel2Izq">Interés Mensual:</label>
                    <asp:TextBox ID="InteresDeposito" runat="server" CssClass="formTextbox formTextboxReadOnly numerico" style="margin-left:-40px; text-align:right" ClientIDMode="Static" readonly="true"></asp:TextBox>
               </div>

            </fieldset>

           <fieldset class="formFieldSet2Der"> <%--<fieldset class="formFieldSet">--%>
               <legend>Parámetros</legend>

               <div class="formLinea">
                   <label id="LabTasaAjusteIDX" for="TasaAjusteIDX" class="formLabel formLabel2Izq">Tasa Ajuste IDX:</label>
                   <asp:TextBox ID="TasaAjusteIDX" runat="server" CssClass="formTextbox numerico" style="margin-left:-40px;  text-align:right" ClientIDMode="Static"></asp:TextBox>
                   <span style="display:block;height:17px;padding-top:5px; margin-left:50px;">&nbsp; %</span>
               </div>
                
               <div class="formLinea">
                   <label id="LabTasaAjusteAJS" for="TasaAjusteAJS" class="formLabel formLabel2Izq">Tasa Ajuste AJS:</label>
                   <asp:TextBox ID="TasaAjusteAJS" runat="server" CssClass="formTextbox formTextboxReadOnly numerico" style="margin-left:-40px;  text-align:right" ClientIDMode="Static" readonly="true"></asp:TextBox>
                   <span style="display:block;height:17px;padding-top:5px; margin-left:50px;">&nbsp; %</span>
               </div>

               <div class="formLinea">
                   <label id="LabTipoCambioParametro" for="TipoCambioParametroTipoCambioParametro" class="formLabel formLabel2Izq">Tipo Cambio:</label>
                   <asp:TextBox ID="TipoCambioParametro" runat="server" CssClass="formTextbox formTextboxReadOnly numerico" style="margin-left:-40px;  text-align:right" ClientIDMode="Static" readonly="true"></asp:TextBox>
               </div>

               <div class="formLinea">
                   <label id="LabCrecimiento" for ="Crecimiento" class="formLabel formLabel2Izq">Crecimiento TC dólar por año:</label>
                   <asp:TextBox ID="Crecimiento" runat="server" CssClass="formTextbox numerico" style="margin-left:-40px;  text-align:right" ClientIDMode="Static"></asp:TextBox>
                   <span style="display:block;height:17px;padding-top:5px; margin-left:50px;">&nbsp; %</span>
               </div>
        ...
        <%--<div class="formLineaBotonSimulacion" align="left" style="margin:0">
            <asp:HyperLink ID="btnRecalcularComparativo" NavigateUrl="#" style="width:150px;height:22px;display:none" CssClass="boton darkblue sharp" runat="server" ClientIDMode="Static">Recalcular Gráfico</asp:HyperLink>
        </div>--%>
        ...
        <div id="CotizacionesSimulador">
            ...
            <div class="formLinea" align="center">
                <asp:HyperLink ID="btnComparar" NavigateUrl="#" style="width:90px;height:22px" CssClass="boton darkblue sharp" runat="server" ClientIDMode="Static">Comparar</asp:HyperLink>
            </div>
        </div>

        
        <div id="Simulaciones" style="display:none;height:765px">
            <div id="Simulacion" style="margin:10px 2px;width:850px;height:770px;" class="areaSimulacionMultiple">
            </div>
        </div>
        
        <div class="formLineaBotonSimulacion" align="center">
            <asp:HyperLink ID="btnNuevoCorreoComparativo" style="width:150px;height:22px;display:none" CssClass="boton darkblue sharp" runat="server" ClientIDMode="Static">Enviar Correo</asp:HyperLink>
            <asp:HyperLink ID="btnPensionProyectadaComparativo" style="width:150px;height:22px;display:none" CssClass="boton darkblue sharp" runat="server" ClientIDMode="Static">Pensión Proyectada</asp:HyperLink>
        </div>
        ...
        <div id="ModalGenerandoReporte" title="Generando reporte" align="center" style="display:none">
            <asp:Image ID="Image2" ImageUrl="~/Imagenes/ajax-loader_1.gif" runat="server" />
            <span class="texto">Calculando pensión, espere por favor...</span>
        </div>
    ...
    <div style="display:none">
        ...
        <div  id="ModalEnvioCorreoSimulador" title="Enviar Correo Electrónico">
            ...
            <div id="ModEnvCorContenidoSimulador" class="modalContenido">
                ...
                <div class="formLinea" align="center">
                    <a id="ModEnvCorEnviarSimuladorComparativo" style="width:80px;height:22px" class="boton darkblue sharp">Enviar</a>
