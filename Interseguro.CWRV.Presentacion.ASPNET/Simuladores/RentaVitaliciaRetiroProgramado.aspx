<%@ Page Title="" Language="C#" MasterPageFile="~/CotWebRVI.Master" AutoEventWireup="true" CodeBehind="RentaVitaliciaRetiroProgramado.aspx.cs" Inherits="Interseguro.CWRV.Presentacion.ASPNET.Simuladores.RentaVitaliciaRetiroProgramado" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Contenido" runat="server">
    ...
    <div align="left" style="width:860px;padding:20px;background:#FFF; border:1px solid #00466e;">
        <h1 id="tituloSimulador" class="simple" style="width:300px">¿Renta Vitalicia o Retiro Programado?</h1>
        ...
        <div class="formLineaBotonSimulacion" align="left" style="margin:0">
            <asp:HyperLink ID="btnRecalcularRentaVitalicia" NavigateUrl="#" style="width:150px;height:22px;display:none" CssClass="boton darkblue sharp" runat="server" ClientIDMode="Static">Recalcular Gráfico</asp:HyperLink>
        </div>
        <%--SRI.INI-20322--%>
        ...
        <div id="Simulaciones" style="display:none;height:597px">
            <%--<div id="Simulacion" style="margin:10px 2px;width:850px;height:587px;" class="areaSimulacion">--%>
            <div id="Simulacion" style="margin:10px 2px;width:850px;height:595px;" class="areaSimulacion">
            </div>
        </div>

        <%--SRI.INI-20322--%>
        <div class="formLineaBotonSimulacion" align="center">
            <asp:HyperLink ID="btnNuevoCorreoRentaVitalicia" style="width:150px;height:22px;" CssClass="boton darkblue sharp" runat="server" ClientIDMode="Static">Enviar Correo</asp:HyperLink>
            <asp:HyperLink ID="btnPensionProyectadaRentaVitalicia" style="width:150px;height:22px;" CssClass="boton darkblue sharp" runat="server" ClientIDMode="Static">Pensión Proyectada</asp:HyperLink>
        </div>
