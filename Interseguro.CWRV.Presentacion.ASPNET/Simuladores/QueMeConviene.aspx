<%@ Page Title="" Language="C#" MasterPageFile="~/CotWebRVI.Master" AutoEventWireup="true" CodeBehind="QueMeConviene.aspx.cs" Inherits="Interseguro.CWRV.Presentacion.ASPNET.Simuladores.QueMeConviene" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Contenido" runat="server">
    ...
    <div align="left" style="width:860px;padding:20px;background:#FFF; border:1px solid #00466e;">
        ...
        <h1 id="tituloSimulador" class="simple" style="width:160px">¿Qué me conviene?</h1>

        <div class="formLinea">
            <label id="LabPromedioRentabilitad" class="formLabel formLabel2Izq">Promedio rentabilidad fondo AFP*:</label>
            <asp:TextBox ID="PromedioRentabilitad" runat="server" CssClass="formTextbox formTextboxReadOnly numerico" Width="60" data-v-max="100.000" data-v-min="-100.000" style="margin-left:-40px" ClientIDMode="Static" Enabled="False"></asp:TextBox>
            <span style="display:block;height:17px;padding-top:3px"><a target="_blank" href="http://www.sbs.gob.pe" class="formLink">www.sbs.gob.pe</a></span>
        </div>
        ...
        <div class="formLinea">
            <label id="LabTipoCambio" class="formLabel formLabel2Izq">Tipo de cambio*:</label>
            <asp:TextBox ID="TipoCambio" runat="server" CssClass="formTextbox formTextboxReadOnly numerico" Width="60" data-v-max="100.000" data-v-min="-100.000" style="margin-left:-40px" ClientIDMode="Static" Enabled="False"></asp:TextBox>
            <span style="display:block;height:17px;padding-top:3px"><a target="_blank" href="http://www.sbs.gob.pe" class="formLink">www.sbs.gob.pe</a></span>
        </div>

<%--        <div class="formLinea">
            <label id="LabAjusteTipoCambio" class="formLabel formLabel2Izq">Ajuste tipo de cambio*:</label>
            <asp:TextBox ID="AjusteTipoCambio" runat="server" CssClass="formTextbox formTextboxReadOnly numerico" Width="60" data-v-max="100.000" data-v-min="-100.000" style="margin-left:-40px" ClientIDMode="Static" Enabled="False"></asp:TextBox>
        </div>--%>

        <%--<div class="formLinea">
            <label id="LabModalidad" class="formLabel formLabel2Izq">Modalidad*:</label>
            <asp:DropDownList ID="Modalidad" runat="server" CssClass="formCombobox formComboboxReadOnly" Width="123" style="margin-left:-40px" ClientIDMode="Static" Enabled="False">
            </asp:DropDownList>
        </div>
        ...
        <div class="formLineaBotonSimulacion" align="left" style="margin:0">
            <asp:HyperLink ID="btnRecalcularQueMeConviene" NavigateUrl="#" style="width:150px;height:22px;display:none" CssClass="boton darkblue sharp" runat="server" ClientIDMode="Static">Recalcular Gráfico</asp:HyperLink>
        </div>
        ...
        <%--<div id="TablaCotizacionesNoSolicitud" class="grilla_info">Seleccione una solicitud para mostrar sus respectivas cotizaciones.</div>
        <div id="TablaCotizacionesCargando" align="center" style="display:none;height:50px;padding:82px 0">
        ...
        <div id="CotizacionesSimulador">
            <table id="GrupoCotizaciones" width="860" border="0" cellspacing="0" cellpadding="0" style="display:none">
                <tr class="grilla_cabecera">
                    <th align="center" style="width:286px;border-left:1px solid #FFF;border-right:1px solid #FFF">MODALIDAD 1</th>
                    <th align="center" style="width:287px;border-left:1px solid #FFF;border-right:1px solid #FFF">MODALIDAD 2</th>
                    <th align="center" style="width:287px;border-left:1px solid #FFF;border-right:1px solid #FFF">MODALIDAD 3</th>
                </tr>
                <tr>
                    <td valign="top">
        ...
        <%--<div id="TablaCotizacionesError" class="grilla_error" style="display:none">No se ha podido cargar la tabla de cotizaciones. <a id="TablaCotizacionesSimuladorReintentar">Intentar de nuevo</a>.</div>--%>
        
        <div id="Simulaciones" style="display:none;height:615px">
            <%--<div id="Simulacion" style="margin:10px 2px;width:850px;height:587px;" class="areaSimulacion">--%>
            <div id="Simulacion" style="margin:10px 2px;width:850px;height:620px;" class="areaSimulacion">
            </div>
        </div>
        
        <div class="formLineaBotonSimulacion" align="center">
            <asp:HyperLink ID="btnNuevoCorreoQueMeConviene" style="width:150px;height:22px;display:none" CssClass="boton darkblue sharp" runat="server" ClientIDMode="Static">Enviar Correo</asp:HyperLink>
            <asp:HyperLink ID="btnPensionProyectadaQueMeConviene" style="width:150px;height:22px;display:none" CssClass="boton darkblue sharp" runat="server" ClientIDMode="Static">Pensión Proyectada</asp:HyperLink>
        </div>
    ...
    <div style="display:none">
        ...
        <div  id="ModalEnvioCorreoSimulador" title="Enviar Correo Electrónico">
            ...
            <div id="ModEnvCorContenidoSimulador" class="modalContenido">
                ...
                <div class="formLinea" align="center">
                    <a id="ModEnvCorEnviarSimuladorRentaVitalicia" style="width:80px;height:22px" class="boton darkblue sharp">Enviar</a>
