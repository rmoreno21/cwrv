<%@ Page Title="" Language="C#" MasterPageFile="~/CotWebRVI.Master" AutoEventWireup="true" CodeBehind="GrupoFamiliarAfiliadoCierre.aspx.cs" Inherits="Interseguro.CWRV.Presentacion.ASPNET.RentaPrivadaPlus.GrupoFamiliarAfiliadoCierre" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Cabecera" runat="server">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            //$("#ModGruFamTipoCtaBanco_RP").change();
...
<asp:Content ID="Content2" ContentPlaceHolderID="Contenido" runat="server">
    ...
    <asp:Panel ID="Grupo_Familiar" runat="server" ClientIDMode="Static" align="left" Style="width: 860px; padding: 20px; background: #FFF; border: 1px solid #00466e">
        <h1 class="simple" style="width: 182px">Datos de Beneficiarios</h1>
        ...
        <asp:HiddenField ID="ModGruFamsoltud" runat="server" ClientIDMode="Static" />
        <asp:HiddenField ID="ModGruFamfecsoltud" runat="server" ClientIDMode="Static" />
        <asp:HiddenField ID="ModGruFamestadosoltud" runat="server" ClientIDMode="Static" />

        <%--<asp:HiddenField ID="Hprofesion" runat="server" ClientIDMode="Static" />
        <asp:HiddenField ID="Hnacionalidad" runat="server" ClientIDMode="Static" />--%>
        <asp:HiddenField ID="HinstitucionLaboral" runat="server" ClientIDMode="Static" />
        <asp:HiddenField ID="Hcargo" runat="server" ClientIDMode="Static" />
        <asp:HiddenField ID="Htelefono" runat="server" ClientIDMode="Static" />
        <asp:HiddenField ID="Hcelular" runat="server" ClientIDMode="Static" />
        <asp:HiddenField ID="HestadoCivil" runat="server" ClientIDMode="Static" />
        <asp:HiddenField ID="HactividadEconomica" runat="server" ClientIDMode="Static" />
        <asp:HiddenField ID="HmonedaIngreso" runat="server" ClientIDMode="Static" />
        <asp:HiddenField ID="HingresoNetoMensual" runat="server" ClientIDMode="Static" />
        <asp:HiddenField ID="HcorreoElectronico" runat="server" ClientIDMode="Static" />
        ...
        <fieldset>
            ...
            <asp:Panel ID="ModGruFamLineaSexoNacimiento_RP" runat="server" ClientIDMode="Static" CssClass="formLineaGrupo">
                ...
                <asp:TextBox ID="ModGruFamFechaNacimiento_RP" runat="server" CssClass="fecha formTextbox formCalendar" Width="176" MaxLength="10" ClientIDMode="Static"></asp:TextBox>
            </asp:Panel>

            <asp:Panel ID="ModGruFamLineaInvalidez_RP" runat="server" ClientIDMode="Static" CssClass="formLineaGrupo">
                ...
                <asp:DropDownList ID="ModGruFamTipoInvalidez_RP" runat="server" CssClass="formCombobox" Width="182" ClientIDMode="Static">
                </asp:DropDownList>
            </asp:Panel>

            <asp:Panel ID="ModGruFamLineaFechaInvalidez_RP" runat="server" ClientIDMode="Static" CssClass="formLineaGrupo">
                ...
                <asp:TextBox ID="ModGruFamFechaInvalidez_RP" runat="server" CssClass="fecha formTextbox formCalendar" Width="182" MaxLength="10" ClientIDMode="Static"></asp:TextBox>
            ...
            <asp:Panel ID="ModGruFamLineaNacionalProfesion_RP" runat="server" ClientIDMode="Static" CssClass="formLineaGrupo">
                ...
                <label id="LabModGruFamResidencia_RP" for="ModGruFamResidencia_RP" class="formLabel formLabel2Der">Residencia:</label>
                <asp:DropDownList ID="ModGruFamResidencia_RP" runat="server" CssClass="formCombobox" Width="182" ClientIDMode="Static">
                </asp:DropDownList>
            </asp:Panel>
            ...
            <asp:Panel ID="ModGruFamLineaEstadocivilMail_RP" runat="server" ClientIDMode="Static" CssClass="formLineaGrupo">
                ...
                <asp:TextBox ID="ModGruFamMail_RP" runat="server" CssClass="formTextbox" Width="182" ClientIDMode="Static" MaxLength="200"></asp:TextBox>
            ...
            <asp:Panel ID="ModGruFamLineaTelefonoCelular_RP" runat="server" ClientIDMode="Static" CssClass="formLineaGrupo">
                ...
                <asp:TextBox ID="ModGruFamTelefono_RP" runat="server" CssClass="formTextbox" Width="182" ClientIDMode="Static" MaxLength="12"></asp:TextBox>

                <label id="LabModGruFamCelular_RP" for="ModGruFamCelular_RP" class="formLabel formLabel2Der">Celular:</label>
                <asp:TextBox ID="ModGruFamCelular_RP" runat="server" CssClass="formTextbox" Width="177" ClientIDMode="Static" MaxLength="12"></asp:TextBox>
            </asp:Panel>
        ...
        <fieldset id="seccionOrigenFondo">
            ...
            <asp:Panel ID="ModGruFamLineaCentrolaboralCargo_RP" runat="server" ClientIDMode="Static" CssClass="formLineaGrupo">
                ...
                <asp:TextBox ID="ModGruFamCargo_RP" runat="server" CssClass="formTextbox" Width="178" ClientIDMode="Static" MaxLength="50"></asp:TextBox>
            </asp:Panel>
            ...
            <asp:Panel ID="ModFruFamLineaDestinoFondosText" runat="server" ClientIDMode="Static" CssClass="formLineaGrupo">
                <textarea class="formTextbox ColorNegro" id="ModGruFamDestinoFondos_RP" cols="127" style="height: 115px; margin-left: 0px;" rows="6"></textarea>
            </asp:Panel>
        ...
        <%--<asp:Panel ID="ModGruFamLineaResidencia_RP" runat="server" ClientIDMode="Static" CssClass="formLinea">
            ...
            <label id="LabModGruFamResidencia_RP" for="ModGruFamResidencia_RP" class="formLabel formLabel2Izq">Residencia:</label>
            <asp:DropDownList ID="ModGruFamResidencia_RP" runat="server" CssClass="formCombobox" Width="628" ClientIDMode="Static">
            </asp:DropDownList>
        </asp:Panel>--%>

        <div class="formLinea" align="center">
            <a id="ModGruFamCancelarCierre_RP" style="width: 120px; height: 22px" class="botonDeshabilitado gris gris_sharp">Anterior</a>
            <a id="ModGruFamAceptarCierre_RP" style="width: 120px; height: 22px" class="botonDeshabilitado gris gris_sharp">Siguiente</a>
        </div>
    ...
    <div style="display: none">
        <%--Inicio Modal Mantenimiento de grupo familiar--%>
        <div id="ModalGrupoFamiliar_RPP" title="Persona Vinculada a cliente PEP">
            <asp:Panel ID="ModGruFamCargando_RPP" runat="server" ClientIDMode="Static" CssClass="modalCargandoContenido" Width="760" Height="147"></asp:Panel>
            <div id="ModGruFamContenido_RPP" class="modalContenido">
                ...
                <asp:Panel ID="ModGruFamLineaIdentificacion_RPP" runat="server" ClientIDMode="Static" CssClass="formLinea">
                    ...
                    <asp:TextBox ID="ModGruFamNumeroIdentificacion_RPP" runat="server" CssClass="formTextbox" Width="180" ClientIDMode="Static" MaxLength="20"></asp:TextBox>
                </asp:Panel>
