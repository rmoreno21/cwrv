<%@ Page Title="" Language="C#" MasterPageFile="~/CotWebRVI.Master" AutoEventWireup="true" CodeBehind="Cotizador.aspx.cs" Inherits="Interseguro.CWRV.Presentacion.ASPNET.RentaPrivadaPlus.Cotizador" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Contenido" runat="server">
    <asp:Panel ID="BusquedaAfiliados_RP" runat="server" ClientIDMode="Static" align="left" Style="width: 860px; padding: 20px; background: rgba(255, 255, 255, 0.8); border: 1px solid #00466e">
        <h1 class="simple" style="width: 265px">Cotizaciones Renta Particular Plus</h1>
        ...
        <fieldset>
            ...
            <div class="formLinea">
                ...
                <asp:HiddenField ID="HCotizado" runat="server" ClientIDMode="Static" Value="0" />
            </div>
        ...
        <fieldset>
            ...
            <div id="Pestanhas">
                ...
                <div id="Pestanha1" align="left" style="display: none; width: 792px; padding: 20px; margin-top: 1px; background: #FFF; border: 1px solid #00466e">
                    ...
                    <asp:HiddenField ID="HToken_RPP" runat="server" ClientIDMode="Static" />
                    ...
                    <asp:HiddenField ID="HindConsentimiento" runat="server" ClientIDMode="Static" />
                     ...
                     <asp:Panel ID="LineaTipoDocumento" runat="server" ClientIDMode="Static" CssClass="formLinea">
                        ...
                        <asp:DropDownList ID="TipoDocumento_RP" runat="server" CssClass="formComboboxTexto formTextboxReadOnly" Width="186" ClientIDMode="Static" Enabled="False"></asp:DropDownList>
                    ...
                    <asp:Panel ID="LineaApellidos_RP" runat="server" ClientIDMode="Static" CssClass="formLinea">
                        ...
                        <asp:TextBox ID="ApellidoPaterno_RP" runat="server" CssClass="formTextbox formTextboxReadOnly formTextboxLetra ColorNegro" Width="180" ClientIDMode="Static" ReadOnly="True"></asp:TextBox>

                        <label id="LabApellidoMaterno_RP" for="ApellidoMaterno_RP" class="formLabel formLabel2Der">Apellido Materno:</label>
                        <asp:TextBox ID="ApellidoMaterno_RP" runat="server" CssClass="formTextbox formTextboxReadOnly formTextboxLetra ColorNegro" Width="180" ClientIDMode="Static" ReadOnly="True"></asp:TextBox>
                    </asp:Panel>
                    ...
                    <asp:Panel ID="LineaNombres_RP" runat="server" ClientIDMode="Static" CssClass="formLinea">
                        ...
                        <asp:TextBox ID="Nombres_RP" runat="server" CssClass="formTextbox formTextboxReadOnly formTextboxLetra ColorNegro" Width="620" ClientIDMode="Static" ReadOnly="True"></asp:TextBox>
                    </asp:Panel>
                    ...
                    <asp:Panel ID="LineaNacimientoSexo_RP" runat="server" ClientIDMode="Static" CssClass="formLinea">
                        ...
                        <asp:TextBox ID="FechaNacimiento_RP" runat="server" CssClass="formTextbox formCalendarReadOnly formTextboxLetra ColorNegro" Width="180" ClientIDMode="Static" ReadOnly="True"></asp:TextBox>
                ...
                <div id="Pestanha3" align="left" style="display: none; width: 792px; padding: 20px; margin-top: 1px; background: #FFF; border: 1px solid #00466e">
                    ...
                    <%--<div id="divListaNegra" runat="server"  visible="false" class="grilla_infoLN">Este Asegurado debe ser validado por el <strong>área PLAFT</strong>. Por favor contactarse con el área PLAFT.</div>--%>
                    ...
                    <div class="formLinea">
                        ...
                        <asp:HyperLink ID="NuevaSolicitud_RP" CssClass="boton darkblue sharp" Style="width: 220px; left: 470px" runat="server" ClientIDMode="Static">Nueva Renta Particular Plus</asp:HyperLink>
    ...
    <div style="display: none">
        ...
        <div id="ModalConsentimientoAsesoria_RPP">
            <div id="ModConsentimientoAsesoriaCargando_RPP" class="modalCargandoContenido" style="display: none; width: 645px; height: 100px"></div>

            <div>
                <table width="100%" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                        <td id="MCConstmAsesIcono_RPP" style="width: 40px; height: 40px"></td>
                        <td id="MCConstmAsesContenedorMensaje_RPP" valign="middle" class="cuadroMensaje">
                            <asp:Panel ID="MCConstmAsesContenedor_RPP" runat="server" ClientIDMode="Static" align="left" Style="margin: 10px 0">
                                <asp:HiddenField ID="MCConstmAsesEstado_RPP" runat="server" ClientIDMode="Static" Value="0" />
                                <asp:HiddenField ID="MCConstmAsesEstadoIcono_RPP" runat="server" ClientIDMode="Static" />
                                <asp:HiddenField ID="MCConstmAsesEstadoTitulo_RPP" runat="server" ClientIDMode="Static" />
                                <asp:Literal ID="MCConstmAsesMensaje_RPP" runat="server"></asp:Literal>
                            </asp:Panel>
                        </td>
                    </tr>
                </table>
            </div>
            <div id="MCConstmAsesBotonera_RPP" align="center">
                <a id="MCConstmAsesEnviar_RPP" class="boton darkblue sharp" style="width: 80px">Enviar</a>
                <a id="MCConstmAsesCancelar_RPP" class="boton darkblue sharp" style="width: 80px">Cancelar</a>
            </div>
        ...
        <div id="ModalReenvioConsentimientoAsesoria">
            ...
            <div id="MRCABotonera" align="center">
                <a id="MRCAEnviar_RPP" class="boton darkblue sharp" style="width: 80px">Enviar</a>
                <a id="MRCACancelar_RPP" class="boton darkblue sharp" style="width: 80px">Cancelar</a>
            </div>
