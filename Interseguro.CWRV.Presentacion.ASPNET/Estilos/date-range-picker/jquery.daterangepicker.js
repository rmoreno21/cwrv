        ...
        function showSelectedDays() {
            ...
            box.find('.day').each(function() {
                ...
                if (
                    ...
                    (opt.start && !opt.end && moment(start).format('DD/MM/YYYY') == moment(time).format('DD/MM/YYYY'))
                ) {
                ...
                if (opt.start && moment(start).format('DD/MM/YYYY') == moment(time).format('DD/MM/YYYY')) {
                    $(this).addClass('first-date-selected');
                } else {
                    $(this).removeClass('first-date-selected');
                }
                //add last-date-selected
                if (opt.end && moment(end).format('DD/MM/YYYY') == moment(time).format('DD/MM/YYYY')) {
