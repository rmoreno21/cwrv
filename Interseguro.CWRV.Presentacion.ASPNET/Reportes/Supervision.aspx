<%@ Page Title="" Language="C#" MasterPageFile="~/CotWebRVI.Master" AutoEventWireup="true" CodeBehind="Supervision.aspx.cs" Inherits="Interseguro.CWRV.Presentacion.ASPNET.Reportes.Supervision" %>
<asp:Content ID="Content1" ContentPlaceHolderID="Cabecera" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="Contenido" runat="server">
    <div align="left" style="width:860px;padding:20px;background:#FFF; border:1px solid #00466e;">
        <h1 class="simple" style="width:190px">Reporte de supervisión</h1>
        ...
        <div class="formLinea" align="center">
            <asp:HyperLink ID="SupBuscar" NavigateUrl="#" style="width:80px;height:22px" CssClass="boton darkblue sharp" runat="server" ClientIDMode="Static">Buscar</asp:HyperLink>
        </div>
        ...
        <div id="TablaSupervisionError" align="center" style="display:none">
            <div class="grilla_error" align="left" style="width:385px;">
                No se ha podido cargar la tabla de seguimiento. <a id="TablaSupervisionReintentar" href="#">Intentar de nuevo</a>.
            </div>
        </div>

        <div id="TablaSupervision" runat="server" style="display:none" clientidmode="Static"></div>

        <asp:HiddenField ID="TabSupervisionIndicePagina" runat="server" ClientIDMode="Static" Value="1" />
        <asp:HiddenField ID="TabSupervisionTamanhoPagina" runat="server" ClientIDMode="Static" Value="10" />
        <asp:HiddenField ID="TabSupervisionColumnaOrdenar" runat="server" ClientIDMode="Static" Value="1" />
        <asp:HiddenField ID="TabSupervisionDireccionOrdenar" runat="server" ClientIDMode="Static" Value="A" />
    </div>
