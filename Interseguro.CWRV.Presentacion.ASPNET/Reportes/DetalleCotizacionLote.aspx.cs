...
{
    public partial class DetalleCotizacionLote : System.Web.UI.Page
    {
            ...
            using (log4net.NDC.Push(MethodBase.GetCurrentMethod().Name))
            {
                try
                {
                    ...
                    if (Utilitarios.ValidarPermiso(HttpContext.Current.Session["OpcionesSistema"], Enums.OpcionesSistema.SolicitudExportarPDF))
                    {
                            ...
                            Response.AddHeader("Content-Disposition", "inline; filename=DetalleCotizacionLote.pdf");
                            //Response.AddHeader("Content-Disposition", "attachment; filename=DetalleCotizacionLote.pdf");
