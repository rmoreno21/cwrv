<%@ Page Title="" Language="C#" MasterPageFile="~/CotWebRVI.Master" AutoEventWireup="true" CodeBehind="ConsolidadoCumplimientoCdA.aspx.cs" Inherits="Interseguro.CWRV.Presentacion.ASPNET.Reportes.ConsolidadoCumplimientoCdA" %>
...
<div id="div" align="left" style="width:860px;padding:20px;background:#FFF; border:1px solid #00466e;">
        <h1 class="simple" style="width:270px">Consolidado de Cumplimiento CdA</h1>
