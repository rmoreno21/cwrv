<%@ Page Language="C#" MasterPageFile="~/CotWebRVI.Master" AutoEventWireup="true" CodeBehind="IndicadorVCTP.aspx.cs" Inherits="Interseguro.CWRV.Presentacion.ASPNET.Reportes.IndicadorVCTP" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Contenido" runat="server">
    <div id="Principal" align="left" style="width: 860px; padding: 20px; background: #FFF; border: 1px solid #00466e">
        <h1 class="simple" style="width: 210px">Reporte Indicadores VCTP</h1>

        <div class="formLinea">
            <label id="LabFechaDesde" for="FechaDesde" class="formLabel">Periodo:</label>
        ...
        <div class="formLinea" align="center">
            <asp:Button ID="btnDescargarVCTP" CssClass="boton darkblue sharp" Width="80"
                Height="24" runat="server" Text="Descargar" ClientIDMode="Static" OnClick="btnDescargarVCTP_Click" />
        </div>
    </div>
